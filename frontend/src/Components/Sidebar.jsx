    ...
    <div>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <a href="#" className="flex items-center pl-2.5 h-14 mb-5">
            <img
              src={logo}
          ...
          <ul className="space-y-2 mt-20 font-medium">
            ...
            <li className="absolute bottom-5">
              ...
              >
                <BiLogOut className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
